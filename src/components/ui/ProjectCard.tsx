...
export function ProjectCard({ project }: { project: Project }) {
  return (
    ...
    >
      <SpotlightCard className="rounded-2xl h-full transition-colors group-hover:bg-zinc-900/50">
        <Link href={project.link || "#"} className="block group-focus-visible:outline-none group-focus-visible:ring-2 group-focus-visible:ring-violet-500 rounded-2xl h-full p-1 active:scale-[0.98] transition-transform duration-200">

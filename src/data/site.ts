export const siteData = {
  hero: {
    title: "Merhaba, ben Ali Yılmaz.",
    subtitle: "Oyuncu, seslendirme sanatçısı ve AI destekli dijital projeler üreten biriyim.",
  ...
  about: {
    ...
    timeline: [
      { year: "2016", title: "Sahneye İlk Adım", description: "Tiyatro ve oyunculuk eğitimleriyle başlayan sanatsal serüven." },
      { year: "2023", title: "Mikrofon Başı", description: "Profesyonel seslendirme stüdyosu kayıtları." },
      { year: "2026", title: "Vibe Coding", description: "Yapay zeka araçları ile uçtan uca dijital ürün geliştirme." }
    ]
  }
};
